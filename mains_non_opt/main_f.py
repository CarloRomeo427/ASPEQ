### MAIN FILE FOR FASPEQ OFFLINE-TO-ONLINE TRAINING WITH STATIC REFERENCE BATCHES
...
from src.algos_non_opt.agent_f import Agent
...
def load_minari_dataset(agent, env_name=None, quality='expert'):
    ...
    Args:
        agent: The FASPEQ agent with a replay buffer
...
def FASPEQ(env_name, seed=0, epochs=300, steps_per_epoch=1000,
    ...
    """
    FASPEQ with static reference batches for policy loss monitoring.
    
    NEW PARAMETERS:
        faspeq_mode: If True, use FASPEQ method with static reference batches (default: False)
    ...
    for t in range(total_steps):
        ...
        if agent.check_should_trigger_offline_stabilization():
            ...
            if faspeq_mode:
                # FASPEQ: Use static reference batches
...
if __name__ == '__main__':
    ...
    parser.add_argument("--algo",type=str,default='faspeq_o2o',help="Algorithm (faspeq_o2o, paspeq_o2o, speq_o2o, sac, etc.)")
    ...
    # ─── FASPEQ-specific ────────────────────────────────────────────────────────
    parser.add_argument("--num-reference-batches",type=int,default=10,help="Number of static reference batches for FASPEQ policy loss monitoring")
    ...
    def set_algo_params(args):
        ...
        if name_algo == "sac":
            ...
            # FASPEQ O2O: Uses static reference batches for policy loss monitoring
            params['offline_epochs'] = 75_000
            params['offline_frequency'] = args.offline_frequency
            params['val_check_interval'] = 1000
            params['val_patience'] = 10000

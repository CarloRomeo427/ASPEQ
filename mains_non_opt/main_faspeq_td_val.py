### MAIN FILE FOR FASPEQ TD VAL (Offline-to-Online with Validation TD Error Proxy)
### Filename: main_td_val.py
...
from src.algos_non_opt.agent_faspeq_td_val import Agent
...
def FASPEQ(env_name, seed=0, epochs=300, steps_per_epoch=1000,
    ...
    for t in range(total_steps):
        ...
        if agent.check_should_trigger_offline_stabilization():
            ...
            # CALL TD-VAL VARIANT
            epochs_performed = agent.finetune_offline_td_val(
...
if __name__ == '__main__':
    ...
    parser.add_argument("--algo",type=str,default='faspeq_td_val',help="Algorithm")
    ...
    params = {
        ...
        'use_minari': True, # Forced for O2O
        'minari_quality': args.minari_quality,
        'auto_stab': True # Enforce dynamic
    }
    ...
    FASPEQ(env_name=args.env, seed=args.seed, epochs=args.epochs, logger_kwargs=logger_kwargs,
           ...
           auto_stab=True, # Active dynamic mode
